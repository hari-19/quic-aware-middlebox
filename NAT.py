...
def main():
    ...
    parser.add_argument('--privateMac', type=str, help='Private MAC')
    ...
    LOG_FILE_NAME = "logs/{}_log.txt".format(PRIVATE_IFACE)
    try:
        os.mkdir("logs")
